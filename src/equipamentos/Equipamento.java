...
public class Equipamento {
	...
	public int usar() {
		 ...
		 */
		System.out.println("Você deseja usar seu item " + getNome() + "? Ainda lhe restam " + getUsos()
				+ " usos! (s para SIM, senão digite qualquer coisa)");
		char c = sc.next().charAt(0);
		if (c == 's' || c == 'S') {
			this.usos--;
			if (usos <= 0)
				System.out.println("O seu equiapento " + nome + " quebrou!!!");
			return getForca();
		}
		return 0;
	}
