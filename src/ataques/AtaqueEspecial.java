...
public class AtaqueEspecial extends Ataque {
	...
	public AtaqueEspecial(String nome, int dano, int chanceCritico, int chanceErro, int chanceEfeito, Efeito efeito,
			int custoMP, String[] classes, int nivelMinimo) {
	...
	public int calcularDanoAtaque() {
		/**
		 * Esta função calcula o dano do ataque, verificando se o ataque critou ou se
		 * errou o ataque
		 *
