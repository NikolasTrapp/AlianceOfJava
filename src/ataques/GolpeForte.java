...
public class GolpeForte extends AtaqueEspecial{
    ...
    public void mostrarAtributos() {
        ...
        System.out.println("Custo de MP: " + getCustoMP());
        System.out.println("Efeito causado: " + getEfeito());
    }
}
